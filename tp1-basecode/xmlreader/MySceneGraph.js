...
export class MySceneGraph {
    ...
    parseComponents(componentsNode) {
        ...
        for (let i = 0; i < children.length; i++) {
            ...
            // Children
            if (childrenIndex != 0 && childrenIndex != 1) this.onXMLError("Children for component " + componentID + " not found");
            ...
            var component = new MyComponent(this.scene, componentID, transformation, componentchildren, leaves);
    ...
    displayComponent(componentID) {
        ...
        for (i in component.leaves) {
            if (component.length_s == null || component.length_t == null)
                this.primitives[component.leaves[i]];

            this.primitives[component.leaves[i]].display();
        }
        for (i in component.children)
            this.displayComponent(component.children[i]);

...
export class MyBuilding2 extends CGFobject {
    constructor(scene, id) {
        ...
        this.buildingTex.loadTexture('scenes/images/buildingResidential.jpg');
        ...
        this.side1 = new MyRectangle(this.scene, "s", 0, 60, 0, 100);
        this.top = new MyRectangle(this.scene, "s", 0, 60, 0, 60);
